...
namespace mygame
{
    ...
    public class BoatModel  
    {
        ...
        public BoatModel(Transform camera)
        {
            ...
            move = boat.AddComponent(typeof(ActionManager)) as ActionManager;
        ...
        public void BoatMove()
        {
            if (boat_sign == -1)
            {
                move.moveBoat(boat,new Vector3(2, 1, 0),maincamera);
                boat_sign = 1;
            }
            else
            {
        ...
        public int GetMove(){ return move.getboatmovesign();}
    ...
    public class RoleModel 
    {
        ...
        public RoleModel(string role_name)
        {
            ...
            move = role.AddComponent(typeof(ActionManager)) as ActionManager;
        ...
        public int GetMove(){return move.getrolemovesign();}
